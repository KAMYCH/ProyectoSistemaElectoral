...
<header>
<img src="imgs/KAMY LOGO.png " style= width:250px height:200px; ><br>
       <p>Elecciones El Salvador <br>
                Bienvenido
 por favor ingrese su número de DUI:</p>
</header>
<body class="votante">
<form  action="sesionDui.php" name="f">
<center>
<div style="width:300px">
<div><input type="Text" name="barra" style="width:200px;border:solid 1px black" class="required form-control" maxlength="10" required="true" placeholder="00000000-0"
 onkeyup="mascara(this,'-',patron3,true)" onkeypress="return justNumbers(event);">
</div>
</div>
                    ...
                    <div class ="row">
                        ...
                        <div class ="col-xs-2">
                            <div class ='label alert-danger'>
                               <?php  print "Ingrese otro Numero de DUI";
                               ?> 
                            </div>
                        </div>
                    </div>
...
<br>
<div align=center id="botones" style="font:normal 20px/18px verdana;visibility:hidden;"></div>
</div>
</div>
</center>
</form>
...
letras=letras+"<input style='width:90px;' type='Button' value="+Tletras[a]+" onclick=anadir('"+Tletras[a]+"')>&nbsp;";
p=p+1;
...
<footer id="footer">
  Diseñado por  <a href=""></a> Kateryn Alejandra Hernandez And <a href=""></a> Yenifer Marisol Campos Gracias a  ITCA Fepade Regional Zacatecoluca
  <p> &copy; </p>
</footer> 
</body>
</html>
